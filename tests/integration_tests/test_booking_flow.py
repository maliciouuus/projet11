...
def test_booking_flow(client):
    ...
    assert updated_points == initial_points - 2  # AMÉLIORATION: Vérification précise de la déduction des points
    ...
    assert updated_places == initial_places - 2  # AMÉLIORATION: Vérification précise de la mise à jour des places
